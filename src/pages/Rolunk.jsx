  ...
  return (
    <div className="page-container" style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
      ...
      <div style={{ marginTop: '80px' }}>
        <Link to="/webshop" className="btn-primary" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#00d4ff', color: 'black', textDecoration: 'none', borderRadius: '5px' }}>
          Irány a Webshop
        </Link>
      </div>
    </div>
